  ...
  <div class="cookies-section">
    ...
    >
      <div class="container ver-align">
        <div class="row">
          <div
            class="col-12 col-lg-3 col-md-12 col-sm-12 bg-white text-lg-left text-md-center text-sm-center text-center m-3"
          >
            <h1 class="industry-title">Cookie Policy</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container mt-5 text-left">
      <div class="row">
        <div class="col-12">
          ...
          <p>This is the Cookie Policy for Price Platform, accessible from priceplatform.com</p>
          ...
          <p>Hopefully that has clarified things for you and as was previously mentioned if there is something that you aren't sure whether you need or not it's usually safer to leave cookies enabled in case it does interact with one of the features you use on our site. This Cookies Policy was created with the help of the Generator of
            <a href="https://cookiepolicygenerator.com">GDPR Cookies Policy Template</a> and the
            <a href="https://cookiespolicytemplate.com/">GDPR Cookies Policy Template</a>.
          </p>

          <p>However if you are still looking for more information then you can contact us through one of our preferred contact methods:</p>

          <ul>
            <li>Email: asd@gmail.bg</li>
          </ul>
        </div>
      </div>
    </div>
